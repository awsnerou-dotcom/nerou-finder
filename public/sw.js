const CACHE_NAME = "nerou-finder-v1";
...
// Stale-while-revalidate for static/navigation requests. API calls always go straight
// to the network so leads, auth, and listing data are never served stale.
